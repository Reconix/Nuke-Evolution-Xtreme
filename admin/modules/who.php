...
echo("<p align=\"center\"><strong>$sitename</strong> - " . _4nwho00 . "<br /><br />" . _4nwho01 . "<a href=\"" . $admin_file . ".php\">"._ADMINMENU."</a><br /><br />" . _4nwho02 . "$serverdate</p>");
...
echo ("<br /><table width=\"100%\" border=\"1\" cellspacing=\"2\" cellpadding=\"2\"><tr><td bgcolor=\"$bgcolor2\"><strong>" . _4nwho04 . "</strong></td><td bgcolor=\"$bgcolor1\"><strong>" . _4nwho05 . "</strong></td><td bgcolor=\"$bgcolor2\"><strong>" . _4nwho06 . "</strong></td><td bgcolor=\"$bgcolor1\"><strong>" . _4nwho10 . "</strong></td><td bgcolor=\"$bgcolor2\"><strong>" . _4nwho07 . "</strong></td></tr>");
...
if($guest == 3) {
        $uname = "<img src=\"images/4nwho/ur-anony.gif\" valign=\"middle\" border=\"0\" alt=\"".$nsnst_const['searchbot']."\">&nbsp;".$nsnst_const['searchbot'];
}
...
echo ("<tr><td bgcolor=\"$bgcolor1\">$uname</td>");
if($guest == 0 || $guest == 2) {
    echo ("<td><img src=\"images/4nwho/green_dot.gif\" valign=\"middle\" alt=\"\">&nbsp;&nbsp;$host_addr</td><td bgcolor=\"$bgcolor1\">");
}else{
    echo ("<td><img src=\"images/4nwho/red_dot.gif\" valign=\"middle\" alt=\"\">&nbsp;&nbsp;$host_addr</td><td bgcolor=\"$bgcolor1\">");
}
...
if($guest == 0 || $guest == 2) {
    echo ("<td bgcolor=\"$bgcolor1\"><img src=\"images/4nwho/green_dot.gif\" valign=\"middle\" alt=\"\">&nbsp;&nbsp;$hour hour : $min min : $sec sec </td>");
}else{
    echo ("<td bgcolor=\"$bgcolor1\"><img src=\"images/4nwho/red_dot.gif\" valign=\"middle\" alt=\"\">&nbsp;&nbsp;$hour hour : $min min : $sec sec </td>");
  }
}
echo ("</tr></table><br />");
