...
sort($cblockslist);
$result2 = $db->sql_query("SELECT * FROM `".$prefix."_nsncb_blocks` WHERE `cgid`='3' ORDER BY `cbid`");
while($cbidinfo = $db->sql_fetchrow($result2)) {
  if($cbidinfo['cbid'] > 1) { echo "<br />\n"; }
  echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
  echo "<tr><td align='center' bgcolor='$bgcolor2' colspan='2'><span>"._CB_BLOCK." "._CB_ID.": ".$cbidinfo['cbid']."</span></td></tr>\n";
  echo "<tr><td bgcolor='$bgcolor2' valign='top'><span>"._CB_TITLE."</span>:</td><td><input type='text' name='x".$cbidinfo['cbid']."title' value='".$cbidinfo['title']."' /></td></tr>\n";
  echo "<tr><td bgcolor='$bgcolor2' valign='top'><span>"._CB_FILENAME."</span>:</td><td><select name='x".$cbidinfo['cbid']."name'>";
  echo "<option ";
  ...
  echo "</select></td></tr>\n";
  echo "<tr><td bgcolor='$bgcolor2' valign='top'><span>"._CB_SPEC."</span>:</td><td><select name='x".$cbidinfo['cbid']."wtype'>";
  ...
  echo "</select></td></tr>\n";
  echo "<tr><td bgcolor='$bgcolor2'><span>"._CB_WID."</span>:</td><td><input size='4' type='text' name='x".$cbidinfo['cbid']."width' value='".$cbidinfo['width']."' /></td></tr>\n";
  echo "<tr><td bgcolor='$bgcolor2' valign='top'><span>"._CB_CONTENT."</span>:</td><td><textarea name='x".$cbidinfo['cbid']."content' $textrowcol wrap='virtual'>".$cbidinfo['content']."</textarea></td></tr>\n";
  echo "<tr><td align='center' colspan='2'><input type='submit' value='"._CB_SAVE."' /></td></tr>\n";
  echo "</table>\n";
}
echo "<input type='hidden' name='op' value='CenterBlocksSave3' /></form>";
CloseTable();
