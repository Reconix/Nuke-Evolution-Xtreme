...
function theme_header(){
    ...
    echo "      <tr>\n";
    echo "        <td><img src='images/evo/ok.png' alt='' width='10' height='10' /></td>\n";
	...
	echo "    </table>\n";
	echo "    <br />\n";
	echo "    [ <a href=\"$admin_file.php?op=theme_users\">" . _THEMES_USER_OPTIONS . "</a> | <a href=\"$admin_file.php?op=theme_options\">" . _THEMES_OPTIONS . "</a> | <a href=\"$admin_file.php\">" . _THEMES_RETURNMAIN . "</a> ]\n";
	echo "</div>\n";
...
function display_main(){
    ...
    function make_a_row($theme){
        ...
        echo "      " . $extract ."\n";
        echo "      <a href=\"$admin_file.php?op=theme_edit&amp;theme=" . $theme['theme_name'] . "\">" . $theme_edit . "</a> \n";
        echo "      " . $default_link . " \n";
        echo "      " . $activate_link . " \n";
        echo "      <a class=\"theme-preview\" href=\"index.php?tpreview=" . $theme['theme_name'] . "\"><img src=\"images/preview.png\" alt=\""._THEMES_VIEW."\" title=\""._THEMES_VIEW."\" border=\"0\" width=\"17\" height=\"17\" /></a> \n";
        echo "      <a href=\"$admin_file.php?op=theme_uninstall&amp;theme=" .$theme['theme_name'] . "\"><img src=\"images/delete.png\" alt=\""._THEMES_UNINSTALL." ".$theme['theme_name']."\" title=\""._THEMES_UNINSTALL." ".$theme['theme_name']."\" border=\"0\" width=\"16\" height=\"16\" /></a>\n";
        echo "  </td>\n";
        echo "</tr>\n";
    }
	...
	echo "  <tr>\n";
	echo "    <th width='18%' align='center'><span class=\"content\" style=\"font-weight: bold\">" . _THEMES_PREVIEW . "</span></th>\n";
	echo "    <th width='15%' align='center'><span class=\"content\" style=\"font-weight: bold\">" . _THEMES_NAME . "</span></th>\n";
	echo "    <th width='15%' align='center'><span class=\"content\" style=\"font-weight: bold\">" . _THEMES_CUSTOMN . "</span></th>\n";
	echo "    <th width='10%' align='center'><span class=\"content\" style=\"font-weight: bold\">" . _THEMES_NUMUSERS . "</span></th>\n";
	echo "    <th width='10%' align='center'><span class=\"content\" style=\"font-weight: bold\">" . _THEMES_STATUS . "</span></th>\n";
	echo "    <th width='15%' align='center'><span class=\"content\" style=\"font-weight: bold\">" . _THEMES_PERMISSIONS . "</span></th>\n";
	echo "    <th width='30%' align='center'><span class=\"content\" style=\"font-weight: bold\">" . _THEMES_OPTS. "</span></th>\n";
	echo "  </tr>\n";
	echo "  <tr>\n";
...
function theme_edit($theme_name){
    ...
    echo "        </fieldset>\n";
    echo "        <br />\n";
    echo "        <center><input type='submit' class='mainoption' value='"._SAVECHANGES."' /> <input type='button' class='mainoption' value='Go Back' onclick='javascript:history.go(-1)' /></center>\n";
    echo "    </td>\n";
    echo "  </tr>";
    echo "</table>\n";
	echo "</form>\n";
...
function theme_install($theme_name){
	...
	echo "            <option value=\"1\" selected='selected'>" . _MVALL . "</option>\n";
	echo "            <option value=\"2\">"._MVGROUPS."</option>\n";
	echo "            <option value=\"3\">" . _MVADMIN . "</option>\n";
	echo "        </select>\n";
	echo "    </td>\n";
	echo "  </tr>";
	echo "  <tr>\n";
...
function theme_options($mode, $post){
    ...
    switch($mode){
        case 'main':
			...
			echo "      </tr>\n";
			echo "      <tr>\n";
			echo "        <td class='row2' colspan='2' align='center'><input type='submit' class='mainoption' value='" . _THEMES_SUBMIT . "' /></td>\n";
			echo "      </tr>\n";
			echo "    </table>\n";
			echo "</div>\n";
			echo "</form>\n";
...
function theme_transfer(){
    global $prefix, $db, $admin_file, $user_prefix, $HTTP_POST_VARS;
    ...
    if (!$HTTP_POST_VARS['transfer']){
		...
		echo "      </tr>\n";
		echo "      <tr>\n";
		echo "        <td colspan='2' align='center'><input type='submit' class='mainoption' value='" . _THEMES_SUBMIT . "' /></td>\n";
		echo "      </tr>\n";
		echo "    </table>\n";
		echo "</div>\n";
		echo "</form>\n";
...
function users_themes(){
	global $db, $user_prefix, $admin_file, $HTTP_GET_VARS;
 ...
 ******************************************************/
    ...
    while($row = $db->sql_fetchrow($result)){
		...
		echo "    <td width='16%' align='center' bgcolor='$bgcolor3'>" .$user_id. "</td>\n";
		echo "    <td width='16%' align='center' bgcolor='$bgcolor3'>" . $username . "</td>\n";
		echo "    <td width='16%' align='center' bgcolor='$bgcolor3'>" . $realname . "</td>\n";
		echo "    <td width='16%' align='center' bgcolor='$bgcolor3'>" . $useremail . "</td>\n";
		echo "    <td width='16%' align='center' bgcolor='$bgcolor3'>" . $usertheme . "</td>\n";
		echo "    <td width='16%' align='center' bgcolor='$bgcolor3'>\n";
		echo "        <select name='op'>\n";
