...
function save_settings($sub) {
    ...
    switch($sub) {
        ...
        case 9:
            ...
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$xanalytics."' WHERE evo_field='analytics'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$xuse_stream."' WHERE evo_field='use_stream'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$xhtml_auth."' WHERE evo_field='html_auth'");
        break;
