...
function BlocksAdmin() {
    ...
    echo "<tr><td width='25%' align='center' valign='top'>\n
    <strong>"._BLOCKSADMIN."</strong><br />
    &nbsp;&nbsp;<img src='images/evo/li.gif' border='0' alt='' /><a href='".$admin_file.".php?op=newBlock'> "._ADDNEWBLOCK."</a></td>\n";
    echo "</tr>\n";
    echo "</table><br />\n";
