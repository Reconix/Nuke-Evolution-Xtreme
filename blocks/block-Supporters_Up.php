...
$content .= "<marquee behavior='scroll' direction='up' height='150' scrollamount='3' scrolldelay='90' width='100' onmouseover='this.stop()' onmouseout='this.start()'><center>\n";
