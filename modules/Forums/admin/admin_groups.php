 ...
 ******************************************************/
		...
		$max_savebox = isset($HTTP_POST_VARS['max_savebox']) ? intval($HTTP_POST_VARS['max_savebox']) : '';
                $override_max_inbox = isset($HTTP_POST_VARS['override_max_inbox']) ? true : false;
                $override_max_sentbox = isset($HTTP_POST_VARS['override_max_sentbox']) ? true : false;
                $override_max_savebox = isset($HTTP_POST_VARS['override_max_savebox']) ? true : false;
/*****[END]********************************************
 [ Mod:     Enhanced BBGroups                  v1.0.0 ]
 ******************************************************/
