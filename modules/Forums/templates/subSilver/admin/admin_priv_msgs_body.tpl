...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr> 
    ...
    <td align="right" valign="bottom">&nbsp;<br /><span class="nav">{PAGINATION}&nbsp;</span></td>
  </tr>
</table></form>
<hr />
<span class="gen"><strong>{L_OPTIONS}</strong> <!--<span class="gensmall">(<a href="">About These</a>)</span>--></span><br />
<span class="genmed">
