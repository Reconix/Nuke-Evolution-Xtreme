...
// eXtreme Styles mod cache. Generated on Wed, 30 Apr 2014 09:34:35 -0600 (time=1398872075)
...
<tr> 
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
    <tr> 
	  ...
	  <th class="thTop" nowrap="nowrap"><?php echo isset($this->vars['L_AGE']) ? $this->vars['L_AGE'] : $this->lang('L_AGE'); ?></th>
...
?>
    <tr> 
      ...
      <!-- FLAGHACK-start -->
      <td class="<?php echo isset($memberrow_item['ROW_CLASS']) ? $memberrow_item['ROW_CLASS'] : ''; ?>" align="center" valign="middle">
        <table class="gen">
          <tr>
            <td align="center" width="100%"><?php echo isset($memberrow_item['FROM']) ? $memberrow_item['FROM'] : ''; ?></td>
            <td align="right"><?php echo isset($memberrow_item['FLAG']) ? $memberrow_item['FLAG'] : ''; ?></td>
          </tr>
        </table>
      </td>
      <!-- FLAGHACK-end -->
      <td class="<?php echo isset($memberrow_item['ROW_CLASS']) ? $memberrow_item['ROW_CLASS'] : ''; ?>" align="center" valign="middle"><span class="gensmall"><?php echo isset($memberrow_item['AGE']) ? $memberrow_item['AGE'] : ''; ?></span></td>
