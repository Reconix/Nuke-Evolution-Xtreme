...
?><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
    <tr <?php echo isset($this->vars['DHTML_HAND']) ? $this->vars['DHTML_HAND'] : $this->lang('DHTML_HAND'); ?> <?php echo isset($this->vars['DHTML_ONCLICK']) ? $this->vars['DHTML_ONCLICK'] : $this->lang('DHTML_ONCLICK'); ?>"show(<?php echo isset($this->vars['DHTML_ID']) ? $this->vars['DHTML_ID'] : $this->lang('DHTML_ID'); ?>)">
        <th  height="25" class="menu" colspan="2"><?php echo isset($this->vars['L_ABILITIES_SETTINGS']) ? $this->vars['L_ABILITIES_SETTINGS'] : $this->lang('L_ABILITIES_SETTINGS'); ?></th>
    </tr>
</table>
...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
    ...
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_SMILIES_IN_TITLES']) ? $this->vars['L_SMILIES_IN_TITLES'] : $this->lang('L_SMILIES_IN_TITLES'); ?></td>
        <td class="row2"><input type="radio" name="smilies_in_titles" value="1" <?php echo isset($this->vars['SMILES_IN_TITLES_YES']) ? $this->vars['SMILES_IN_TITLES_YES'] : $this->lang('SMILES_IN_TITLES_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="smilies_in_titles" value="0" <?php echo isset($this->vars['SMILES_IN_TITLES_NO']) ? $this->vars['SMILES_IN_TITLES_NO'] : $this->lang('SMILES_IN_TITLES_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_HIDE_LINKS']) ? $this->vars['L_HIDE_LINKS'] : $this->lang('L_HIDE_LINKS'); ?></td>
        <td class="row2"><input type="radio" name="hide_links" value="1" <?php echo isset($this->vars['HIDE_LINKS_YES']) ? $this->vars['HIDE_LINKS_YES'] : $this->lang('HIDE_LINKS_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="hide_links" value="0" <?php echo isset($this->vars['HIDE_LINKS_NO']) ? $this->vars['HIDE_LINKS_NO'] : $this->lang('HIDE_LINKS_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_HIDE_IMAGES']) ? $this->vars['L_HIDE_IMAGES'] : $this->lang('L_HIDE_IMAGES'); ?></td>
        <td class="row2"><input type="radio" name="hide_images" value="1" <?php echo isset($this->vars['HIDE_IMAGES_YES']) ? $this->vars['HIDE_IMAGES_YES'] : $this->lang('HIDE_IMAGES_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="hide_images" value="0" <?php echo isset($this->vars['HIDE_IMAGES_NO']) ? $this->vars['HIDE_IMAGES_NO'] : $this->lang('HIDE_IMAGES_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_HIDE_EMAILS']) ? $this->vars['L_HIDE_EMAILS'] : $this->lang('L_HIDE_EMAILS'); ?></td>
        <td class="row2"><input type="radio" name="hide_emails" value="1" <?php echo isset($this->vars['HIDE_EMAILS_YES']) ? $this->vars['HIDE_EMAILS_YES'] : $this->lang('HIDE_EMAILS_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="hide_emails" value="0" <?php echo isset($this->vars['HIDE_EMAILS_NO']) ? $this->vars['HIDE_EMAILS_NO'] : $this->lang('HIDE_EMAILS_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_SHOW_EDITED_LOGS']) ? $this->vars['L_SHOW_EDITED_LOGS'] : $this->lang('L_SHOW_EDITED_LOGS'); ?></td>
        <td class="row2"><input type="radio" name="show_edited_logs" value="1" <?php echo isset($this->vars['SHOW_EDITED_LOGS_YES']) ? $this->vars['SHOW_EDITED_LOGS_YES'] : $this->lang('SHOW_EDITED_LOGS_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="show_edited_logs" value="0" <?php echo isset($this->vars['SHOW_EDITED_LOGS_NO']) ? $this->vars['SHOW_EDITED_LOGS_NO'] : $this->lang('SHOW_EDITED_LOGS_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_SHOW_LOCKED_LOGS']) ? $this->vars['L_SHOW_LOCKED_LOGS'] : $this->lang('L_SHOW_LOCKED_LOGS'); ?></td>
        <td class="row2"><input type="radio" name="show_locked_logs" value="1" <?php echo isset($this->vars['SHOW_LOCKED_LOGS_YES']) ? $this->vars['SHOW_LOCKED_LOGS_YES'] : $this->lang('SHOW_LOCKED_LOGS_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="show_locked_logs" value="0" <?php echo isset($this->vars['SHOW_LOCKED_LOGS_NO']) ? $this->vars['SHOW_LOCKED_LOGS_NO'] : $this->lang('SHOW_LOCKED_LOGS_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_SHOW_UNLOCKED_LOGS']) ? $this->vars['L_SHOW_UNLOCKED_LOGS'] : $this->lang('L_SHOW_UNLOCKED_LOGS'); ?></td>
        <td class="row2"><input type="radio" name="show_unlocked_logs" value="1" <?php echo isset($this->vars['SHOW_UNLOCKED_LOGS_YES']) ? $this->vars['SHOW_UNLOCKED_LOGS_YES'] : $this->lang('SHOW_UNLOCKED_LOGS_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="show_unlocked_logs" value="0" <?php echo isset($this->vars['SHOW_UNLOCKED_LOGS_NO']) ? $this->vars['SHOW_UNLOCKED_LOGS_NO'] : $this->lang('SHOW_UNLOCKED_LOGS_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_SHOW_MOVED_LOGS']) ? $this->vars['L_SHOW_MOVED_LOGS'] : $this->lang('L_SHOW_MOVED_LOGS'); ?></td>
        <td class="row2"><input type="radio" name="show_moved_logs" value="1" <?php echo isset($this->vars['SHOW_MOVED_LOGS_YES']) ? $this->vars['SHOW_MOVED_LOGS_YES'] : $this->lang('SHOW_MOVED_LOGS_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="show_moved_logs" value="0" <?php echo isset($this->vars['SHOW_MOVED_LOGS_NO']) ? $this->vars['SHOW_MOVED_LOGS_NO'] : $this->lang('SHOW_MOVED_LOGS_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_SHOW_SPLITTED_LOGS']) ? $this->vars['L_SHOW_SPLITTED_LOGS'] : $this->lang('L_SHOW_SPLITTED_LOGS'); ?></td>
        <td class="row2"><input type="radio" name="show_splitted_logs" value="1" <?php echo isset($this->vars['SHOW_SPLITTED_LOGS_YES']) ? $this->vars['SHOW_SPLITTED_LOGS_YES'] : $this->lang('SHOW_SPLITTED_LOGS_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="show_splitted_logs" value="0" <?php echo isset($this->vars['SHOW_SPLITTED_LOGS_NO']) ? $this->vars['SHOW_SPLITTED_LOGS_NO'] : $this->lang('SHOW_SPLITTED_LOGS_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_ALLOW_VIEW']) ? $this->vars['L_ALLOW_VIEW'] : $this->lang('L_ALLOW_VIEW'); ?></td>
        <td class="row2"><?php echo isset($this->vars['ALLOW_VIEW_SELECT']) ? $this->vars['ALLOW_VIEW_SELECT'] : $this->lang('ALLOW_VIEW_SELECT'); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_LOGIN_PAGE']) ? $this->vars['L_LOGIN_PAGE'] : $this->lang('L_LOGIN_PAGE'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_LOGIN_PAGE_EXPLAIN']) ? $this->vars['L_LOGIN_PAGE_EXPLAIN'] : $this->lang('L_LOGIN_PAGE_EXPLAIN'); ?></span></td>
        <td class="row2"><input type="radio" name="loginpage" value="1" <?php echo isset($this->vars['LOGINPAGE_YES']) ? $this->vars['LOGINPAGE_YES'] : $this->lang('LOGINPAGE_YES'); ?> /><?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?>&nbsp; &nbsp;<input type="radio" name="loginpage" value="0" <?php echo isset($this->vars['LOGINPAGE_NO']) ? $this->vars['LOGINPAGE_NO'] : $this->lang('LOGINPAGE_NO'); ?> /><?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_IMAGE_RESIZE_WIDTH']) ? $this->vars['L_IMAGE_RESIZE_WIDTH'] : $this->lang('L_IMAGE_RESIZE_WIDTH'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_IMAGE_RESIZE_WIDTH']) ? $this->vars['L_IMAGE_RESIZE_WIDTH'] : $this->lang('L_IMAGE_RESIZE_WIDTH'); ?></span></td>
        <td class="row2"><input class="post" type="text" size="5" maxlength="4" name="image_resize_width" value="<?php echo isset($this->vars['IMAGE_RESIZE_WIDTH']) ? $this->vars['IMAGE_RESIZE_WIDTH'] : $this->lang('IMAGE_RESIZE_WIDTH'); ?>" /></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_IMAGE_RESIZE_HEIGHT']) ? $this->vars['L_IMAGE_RESIZE_HEIGHT'] : $this->lang('L_IMAGE_RESIZE_HEIGHT'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_IMAGE_RESIZE_HEIGHT']) ? $this->vars['L_IMAGE_RESIZE_HEIGHT'] : $this->lang('L_IMAGE_RESIZE_HEIGHT'); ?></span></td>
        <td class="row2"><input class="post" type="text" size="5" maxlength="4" name="image_resize_height" value="<?php echo isset($this->vars['IMAGE_RESIZE_HEIGHT']) ? $this->vars['IMAGE_RESIZE_HEIGHT'] : $this->lang('IMAGE_RESIZE_HEIGHT'); ?>" /></td>
    </tr>
</table>
</span>