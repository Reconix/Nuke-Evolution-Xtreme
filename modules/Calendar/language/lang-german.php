...
// $Id: lang-german.php,v 20.12 2004/04/15 16:58:47 EllselAn Exp $
...
#/modules/Calendar/language/lang-german.php
#Sie-Version von Hajo Sackmann, webmaster@einewahrheit.de am 24.5.03 um 19.00
...
define("_CALTHANKSSUB", "Vielen Dank f&uuml;r Ihre Einsendung!");
define("_CALSUBTEXT", "In den n&auml;chsten Stunden wird Ihr Eintrag gepr&uuml;ft und gegebenenfalls ver&ouml;ffentlicht.");
define("_CALSUBTEXTADMIN", "Ihr Eintrag wurde sofort ver&ouml;ffentlicht.");
...
define("_CALCHECKSTORY", "Bitte &uuml;berpr&uuml;fen Sie Text, Links, etc., BEVOR Sie Ihren Termin senden!");
...
define("_CALBEDESCRIPTIVE", "Beschreiben Sie bitte kurz und pr&auml;zise!");
define("_CALSUBPREVIEW", "Vor der &Uuml;bertragung m&uuml;ssen Sie zun&auml;chst die Vorschau ansehen");
...
define("_CALSUBMITADVICE1", "F&uuml;llen Sie bitte das folgende Formular aus.");
define("_CALSUBMITADVICE2", "Wir m&ouml;chten Sie darauf hinweisen, dass nicht alle Termine ver&ouml;ffentlicht werden.<br />Eventuell nehmen wir uns die Freiheit, Ihren Termin zu &uuml;berarbeiten.");
...
#define("_CALBARCOLORTEXT","Bitte w&auml;hlen Sie eine Kategorie f&uuml;r den Termin aus");
define("_CALBARCOLORTEXT","Kategorie");
define("_CALLOGIN","Login");
define("_CALNO","Nein");
define("_CALYES","Ja");
define("_CALREMOVETEST","Sind Sie sicher, dass Sie diesen Termin entfernen m&ouml;chten?");
define("_CALNOTAUTHORIZED1","Sie sind nicht berechtigt, diesen Eintrag zu &auml;ndern oder zu entfernen!");
define("_CALNOTAUTHORIZED2","F&uuml;r Fragen konsultieren Sie bitte den Systemadministrator");
...
define('_CALMOREOPTIONINF','Weitere Optionen zur optischen Konfiguration des Kalenders finden sie in der Datei:');
