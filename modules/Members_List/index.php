 ...
 ******************************************************/
$mode_types_text = array($lang['Sort_Joined'], $lang['Sort_Username'], $lang['Sort_Location'], $lang['Sort_Posts'], $lang['Sort_Age'], $lang['Sort_Email'],  $lang['Sort_Website'], $lang['Sort_Top_Ten'], $lang['Online_status']);
$mode_types = array('joined', 'username', 'location', 'posts', 'age', 'email', 'website', 'topten', 'online');
/*****[END]********************************************
 [ Mod:    Birthdays                           v3.0.0 ]
 [ Mod:    Selection Order                     v1.0.0 ]
 ******************************************************/
...
{
    $sql = "SELECT username, user_id, user_viewemail, user_posts, user_birthday, birthday_display, user_regdate, user_from, user_from_flag, user_website, user_email, user_icq, user_aim, user_yim, user_msnm, user_avatar, user_avatar_type, user_allowavatar, user_allow_viewonline, user_session_time
        FROM " . USERS_TABLE . "
...
/*****[BEGIN]******************************************
 [ Mod:     Member Country Flags               v2.0.7 ]
 ******************************************************/
				$flag = ( !empty($row['user_from_flag']) ) ? "&nbsp;<img src=\"images/flags/". $row['user_from_flag'] ."\" alt=\"". $row['user_from_flag'] ."\">" : '&nbsp;<img src="images/flags/blank.png" alt="">';
/*****[END]********************************************
 [ Mod:     Member Country Flags               v2.0.7 ]
 ******************************************************/
