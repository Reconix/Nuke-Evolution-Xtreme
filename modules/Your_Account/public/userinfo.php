 ...
 ******************************************************/
        ...
        while ($sqlvalue = $db->sql_fetchrow($result)) {
            ...
            echo "<tr>\n<td width='30%' bgcolor='$bgcolor1'>"._ICQ."</td>\n<td width='70%' bgcolor='$bgcolor1'><strong>$usrinfo[user_icq]</strong></td>\n</tr>\n";
            echo "<tr>\n<td width='30%' bgcolor='$bgcolor1'>"._AIM."</td>\n<td width='70%' bgcolor='$bgcolor1'><strong>$usrinfo[user_aim]</strong></td>\n</tr>\n";
            echo "<tr>\n<td width='30%' bgcolor='$bgcolor1'>"._YIM."</td>\n<td width='70%' bgcolor='$bgcolor1'><strong>$usrinfo[user_yim]</strong></td>\n</tr>\n";
            echo "<tr>\n<td width='30%' bgcolor='$bgcolor1'>"._MSNM."</td>\n<td width='70%' bgcolor='$bgcolor1'><strong>$usrinfo[user_msnm]</strong></td>\n</tr>\n";
