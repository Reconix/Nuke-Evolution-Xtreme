...
//      echo "<tr><td><strong>"._YA_PASSWORD.":</strong> $user_password<br /></td></tr>";
        ...
        echo "<input type='hidden' name='user_icq' value=\"$user_icq\">\n";
        echo "<input type='hidden' name='user_aim' value=\"$user_aim\">\n";
        echo "<input type='hidden' name='user_yim' value=\"$user_yim\">\n";
        echo "<input type='hidden' name='user_msnm' value=\"$user_msnm\">\n";
