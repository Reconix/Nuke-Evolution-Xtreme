...
function display_config() {
    ...
    echo "<tr>\n
          ...
          <tr>\n
           ...
           <tr><td align=\"right\">".$lang_donate['MESSAGE'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text_area('message', br2nl($block_values['message']))."</td>\n
         </tr>\n";
