...
function display_config() {
    ...
    echo "<tr>\n";
    echo "  <td align=\"right\">".$lang_donate['PP_EMAIL'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text('pp_email', $gen_values['pp_email'])."</td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    ...
    echo "  <td align=\"right\">".$lang_donate['DONATION_NAME'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text('donation_name', $gen_values['donation_name'],'','',make_help_popup($lang_donate['HELP_DONATION_NAME'],$lang_donate['DONATION_NAME']))."</td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "  <td align=\"right\">".$lang_donate['DONATION_CODE'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text('donation_code', $gen_values['donation_code'],'','',make_help_popup($lang_donate['HELP_DONATION_CODE'],$lang_donate['DONATION_CODE']))."</td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "  <td align=\"right\">".$lang_donate['MONTHLY_GOAL'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text('monthly_goal', $gen_values['monthly_goal'],5,7)."</td>\n";
    echo "</tr>\n";
    echo "<tr>\n
            <td align=\"right\">".$lang_donate['BUTTON_IMAGE'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text('button_image', $gen_values['button_image'])."</td>\n
          </tr>\n";
    echo "<tr>\n
            <td align=\"right\">".$lang_donate['PAGE_HEADER_IMG'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text('page_image', $gen_values['page_image'])."</td>\n
          </tr>\n";
    echo "<tr>\n";
    echo "  <td align=\"right\">".$lang_donate['DATE_FORMAT'].$lang_donate['BREAK']."</td>\n
            <td>".donate_text('date_format', $gen_values['date_format'])."</td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
