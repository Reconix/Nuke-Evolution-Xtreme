...
function config_select () {
  ...
  <tr>\n
    <td align=\"center\"><a href=\"".$admin_file.".php?op=Donations&amp;file=current\"><img src=\"images/donations/view.png\" border=\"0\" alt=\"".$lang_donate['CURRENT_DONATIONS']."\"><br />".$lang_donate['CURRENT_DONATIONS']."</a></td>\n
    <td align=\"center\"><a href=\"".$admin_file.".php?op=Donations&amp;file=add\"><img src=\"images/donations/add.png\" border=\"0\" alt=\"".$lang_donate['ADD_DONATION']."\"><br />".$lang_donate['ADD_DONATION']."</a></td>\n
    <td align=\"center\"><a href=\"".$admin_file.".php?op=Donations&amp;file=values\"><img src=\"images/donations/money.png\" border=\"0\" alt=\"".$lang_donate['DONATION_VALUES']."\"><br />".$lang_donate['DONATION_VALUES']."</a></td>\n
  </tr>\n
  <tr>\n
    <td align=\"center\"><a href=\"".$admin_file.".php?op=Donations&amp;file=config_block\"><img src=\"images/admin/blocks.png\" border=\"0\" alt=\"".$lang_donate['CONFIG_BLOCK']."\"><br />".$lang_donate['CONFIG_BLOCK']."</a></td>\n
    <td align=\"center\"><a href=\"".$admin_file.".php?op=Donations&amp;file=config_donations\"><img src=\"images/admin/donator.png\" border=\"0\" alt=\"".$lang_donate['CONFIG_GENERAL']."\"><br />".$lang_donate['CONFIG_GENERAL']."</a></td>\n
    <td align=\"center\"><a href=\"".$admin_file.".php?op=Donations&amp;file=config_page\"><img src=\"images/donations/page.png\" border=\"0\" alt=\"".$lang_donate['CONFIG_PAGE']."\"><br />".$lang_donate['CONFIG_PAGE']."</a></td>\n
  </tr>\n
</table>";
}
