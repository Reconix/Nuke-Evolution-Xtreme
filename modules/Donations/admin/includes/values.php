...
function display_values($values) {
    ...
    echo '<p align="center" style="font-size: large; font-weight: bold;">'.$lang_donate['DONATION_VALUES'].' </p>';
    echo '<form id="values" method="post" action="'.$admin_file.'.php?op=Donations&amp;file=values"><table width="7%" border="1" align="center">';
    for ($i = 1; $i <= 5; $i++) {
        echo '<tr>';
            echo '<td width="25%">';
