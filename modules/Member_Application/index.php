...
$MAuser_info = cookiedecode($user);
if ((is_user($user)) || ($mrow['annon']))
{
/*
  if (is_user($user))
  {
    $sql = "SELECT * FROM ".$user_prefix."_users WHERE username='$MAuser_info[1]'";
    ...
    if ($user_posts < $minimum_posts)
    {
      echo "<BR /><center>".$posts_message."</center><BR />";
      CloseTable();
      include("footer.php");
      die();
    }
