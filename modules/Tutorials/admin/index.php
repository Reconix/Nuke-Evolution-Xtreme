...
if ($row2['radminsuper'] == 1 || $auth_user == 1) {
	function tut_getparent($parentid,$title) {
		...
		if ($pparentid!=0) {
			$title=tut_getparent($pparentid,$title);
		}
		return $title;
	}
	...
	function main (){
		...
		include ("header.php");
		OpenTable();
		echo "<center><font class=\"title\"><b>"._TUTADMIN."</b></font><br><a href=\"".$admin_file.".php\">"._TUTADMINBACK."</a></center>";
		CloseTable();
		echo "<br>";
	...
	function category(){
		...
		echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
		OpenTable();
		echo "<form method=\"post\" action=\"".$admin_file.".php\"><font class=\"content\"><center><b>"._TUTADMINADDMAINCATEGORY."</b></center><br><br>"._TUTADMINNAME.": <input type=\"text\" name=\"tc_title\" size=\"30\" maxlength=\"100\"><br>"._TUTADMINDESCRIPTION.":<br><textarea name=\"description\" cols=\"60\" rows=\"10\"></textarea><br><input type=\"hidden\" name=\"op\" value=\"addcategory\"><input type=\"submit\" value=\""._TUTADMINADD."\"><br></form>";
		CloseTable();
		echo "<br>";
		...
		if ($numrows>0) {
			OpenTable();
			echo "<form method=\"post\" action=\"".$admin_file.".php\"><font class=\"content\"><center><b>"._TUTADMINADDSUBCATEGORY."</b></center></font><br><br>"._TUTADMINNAME.": <input type=\"text\" name=\"tt_title\" size=\"30\" maxlength=\"100\"><br>"._TUTADMININ."&nbsp;";
			...
			while(list($tc_id2, $tc_title2, $parentid2) = $db->sql_fetchrow($result2)) {
				if ($parentid2!=0) {
					$tc_title2=tut_getparent($parentid2,$tc_title2);
				}
	...
	function modcategory() {
		...
		echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
		OpenTable();
		echo "<form method=\"post\" action=\"".$admin_file.".php\"><font class=\"content\"><center><b>"._TUTADMINMODCATEGORY."</b></center></font><br><br>";
	...
	function transfercategory() {
		...
		echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
		OpenTable();
		echo "<form method=\"post\" action=\"".$admin_file.".php\"><font class=\"option\"><b>"._TUTADMINTRANSFERTUTORIALS."</b></font><br><br>"._TUTADMINCATEGORY.": <select name=\"cidfrom\">";
		$result2=$db->sql_query("select tc_id, tc_title, parentid from ".$prefix."_tutorials_categories order by parentid,tc_title");
		while(list($tc_id2, $tc_title2, $parentid2) = $db->sql_fetchrow($result2)) {
			if ($parentid2!=0) {
				$tc_title2=tut_getparent($parentid2,$tc_title2);
	...
	function tutorial_form(){
		global $admin_file, $module_name;
		include("modules/$module_name/include/bbcode_javascript.php");
	...
	function addtutorial()
	{
		...
		OpenTable();
			...
			echo "<div align=\"center\"><font class=\"title\"><b>". _TUTADMIN ."</b></font><br><a href=\"". $admin_file .".php\">". _TUTADMINBACK ."</a></div>";
		...
		OpenTable();
			...
			echo "<font class=\"content\"><b><center>"._TUTADMINADDNEWTUTORIAL."</center></b>";
			echo "<br /><br />";
			echo _TUTADMINTUTORIALNAME.": <input type=\"text\" name=\"t_title\" size=\"50\" maxlength=\"100\"><br>";
			$result2 = $db->sql_query("select tc_id, tc_title, parentid from ".$prefix."_tutorials_categories order by tc_title");
			...
			echo "</select><br><br>". _TUTADMINDESCRIPTION255;
			echo "<br />";
			//echo "<textarea name=\"description\" cols=\"60\" rows=\"5\"></textarea>";
			echo Make_TextArea('description', '', 'post', '100%', '300px', true);
			echo "<br /><br />";
			//tutorial_form();
			...
			//echo "      <textarea name=\"message\" rows=\"40\" cols=\"100%\" wrap=\"virtual\" class=\"post\" onselect=\"storeCaret(this);\" onclick=\"storeCaret(this);\" onkeyup=\"storeCaret(this);\"></textarea></span>";
			echo Make_TextArea('message', '', 'post', '100%', '300px', true);
			echo "    </td>";
			echo "  </tr>";
			echo "</table>";
	...
	*/
	...
	/*function addtutorial(){
		...
		echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
		OpenTable();
		echo "<form method=\"post\" name=\"post\" action=\"".$admin_file.".php\"><font class=\"content\"><b><center>"._TUTADMINADDNEWTUTORIAL."</center></b><br><br>"._TUTADMINTUTORIALNAME.": <input type=\"text\" name=\"t_title\" size=\"50\" maxlength=\"100\"><br>";
		$result2=$db->sql_query("select tc_id, tc_title, parentid from ".$prefix."_tutorials_categories order by tc_title");
		echo ""._TUTADMINCATEGORY.": <select name=\"tc_id\">";
		while(list($tc_id2, $tc_title2, $parentid2) = $db->sql_fetchrow($result2)) {
			if ($parentid2!=0) {
	...
	function modifytutorial(){
		...
		echo "<font class=\"content\"><b><center>"._TUTADMINMODTUTORIAL."</center></b><br><br><br>";
		...
		echo "<font class=\"content\"><b><center>"._TUTADMINMODTUTORIAL2."</center></b><br><br><br>";
	...
	function modtutorialsave($t_id, $t_title, $tc_id, $description, $t_text, $author, $author_email, $author_homepage, $hits, $version, $level) {
		global $admin_file, $prefix, $db, $module_name;
		include("modules/$module_name/include/bbstuff.php");
		$t_id = intval($t_id);
		if ($t_title=="") {
			include ("header.php");
			OpenTable();
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORNOTITLE."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		}
		if ($description=="") {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORNODESCRIPTION."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		}
		if ($t_text=="") {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORNOTUTORIAL."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		}
		if ($author=="") {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORNOAUTHOR."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		}
		if ($author_email=="") {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORNOAUTHORMAIL."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		}
		if ($author_homepage=="") {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORNOAUTHORSITE."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		}
		if ($version=="") {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORNOVERSION."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		}
	...
	function modtutorial($t_id) 
	{
		...
		echo "<center><font class=\"content\"><b>"._TUTADMINMODTUTORIAL."</b></font></center><br><br>";
		...
		echo ""._TUTADMINTUTORIALID.": <b>$t_id</b><br>";
		echo "<br>";
		if ($submitter != "") {
			echo ""._TUTADMINSUBMITTER.": <b>$submitter</b><br>";
			echo "<br>";
		}
		...
		while(list($cid2, $ctitle2, $parentid2) = $db->sql_fetchrow($result2)) {
			...
			if ($parentid2!=0) {
				$ctitle2=tut_getparent($parentid2,$ctitle2);
			}
		...
		echo Make_TextArea('description', $description, 'post', '100%', '300px', true);
		echo "<br /><br />";
		...
		echo "<tr><td colspan='7' valign='top'><b>"._TUTADMINCOMMENTS.$totalcomments.")</b><br><br></td></tr>";
		echo "<tr><td width='20' colspan='1'><b>"._TUTADMINUSER."  </b></td><td colspan=5><b>"._TUTADMINCOMMENT."  </b></td><td><b><center>"._TUTADMINDELETE."</center></b></td></tr>";
		...
		while(list($ratingdbid, $ratinguser, $ratingcomments, $ratingtimestamp)=$db->sql_fetchrow($result5)) {
			...
			echo "<tr><td valign='top' bgcolor='$colorswitch'>$ratinguser</td><td valign='top' colspan='5' bgcolor='$colorswitch'>$ratingcomments</td><td bgcolor='$colorswitch'><center><b><a href='".$admin_file.".php?op=delcomment&t_id=$t_id&rid=$ratingdbid'>X</a></b></center><br><br></td></tr>";
			$x++;
		...
		echo "<tr><td colspan=7><b>"._TUTADMINREGVOTES.$totalvotes.")</b><br><br></td></tr>";
		echo "<tr><td><b>"._TUTADMINUSER."  </b></td><td><b>"._TUTADMINIPADDRESS."  </b></td><td><b>"._TUTADMINRATING."  </b></td><td><b>"._TUTADMINUAVGRATING."  </b></td><td><b>"._TUTADMINTOTALRATINGS."  </b></td><td><b>"._TUTADMINDATE."  </b></td></font></b><td><b><center>"._TUTADMINDELETE."</center></b></td></tr>";
		...
		$totalvotes = $db->sql_numrows($result5);
		echo "<tr><td colspan=7><b>"._TUTADMINUNREGVOTES.$totalvotes.")</b><br><br></td></tr>";
		echo "<tr><td colspan=2><b>"._TUTADMINIPADDRESS."  </b></td><td colspan=3><b>"._TUTADMINRATING."  </b></td><td><b>"._TUTADMINDATE."  </b></font></td><td><b><center>"._TUTADMINDELETE."</center></b></td></tr>";
		...
		while(list($ratingdbid, $rating, $ratinghostname, $ratingtimestamp)=sql_fetch_row($result5, $dbi)) {
			...
			$timestamp = mktime(0, 0, 0, $date_array["1"], $date_array["2"], $date_array["0"]);
			$formatted_date = date("F j, Y", $timestamp);
			echo "<td colspan=2 bgcolor=$colorswitch>$ratinghostname</td><td colspan=3 bgcolor=$colorswitch>$rating</td><td bgcolor=$colorswitch>$formatted_date  </font></b></td><td bgcolor=$colorswitch><center><b><a href=\"".$admin_file.".php?op=delvote&t_id=$t_id&rid=$ratingdbid\">X</a></b></center></td></tr>";
			$x++;
			if ($colorswitch=="$bgcolor1") {
				$colorswitch="$bgcolor2";
			} else {
	...
	function delvote($t_id, $rid) {
		...
		include ("include/voteinclude.php");
	...
	function cleanvotes($ok=0) {
		...
		OpenTable();
		echo "<center><br><br>";
		echo "<b>"._TUTADMINSURECLEANVOTE."</b><br>";
		echo "<br><br>";
	...
	function deltutorial($t_id, $ok=0) {
		...
		OpenTable();
		echo "<center><br><br>";
		echo "<b>"._TUTADMINSUREDELTUTORIAL."</b><br>";
		echo "<br><br>";
		echo "<input type=\"button\" value=\""._TUTADMINBYES."\" title=\""._TUTADMINYES."\" ";
	...
	function modcat($cat) {
		...
		OpenTable();
		echo "<center><font class=\"content\"><b>"._TUTADMINMODCATEGORY."</b></font></center><br><br>";
		if ($cat[1]==0) {
	...
	function modcatdelete($tc_id, $ok=0) {
		...
		if($ok==1) {
			...
			echo "<b>"._TUTADMINTHEREIS." $nbsubcat "._TUTADMINSUBCAT." "._TUTADMINATTACHEDTOCAT."</b><br>";
			echo "<b>"._TUTADMINTHEREIS." $nblink "._TUTMAINTUTORIALS." "._TUTADMINATTACHEDTOCAT."</b><br>";
			echo "<b>"._TUTADMINDELTUTORIALCATWARNING."</b><br><br>";
		}
	...
	function addcategory($tc_title, $description) {
		...
		if ($numrows>0) {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<br><center><font class=\"content\"><b>"._TUTADMINERRORTHECATEGORY." $tc_title "._TUTADMINALREADYEXIST."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		} else {
	...
	function addsubcategory($tc_id, $tc_title, $description) {
		...
		if ($numrows>0) {
			...
			OpenTable();
			echo "<br><center>";
			echo "<font class=\"content\"><b>"._TUTADMINERRORTHESUBCATEGORY." $tc_title "._TUTADMINALREADYEXIST."</b><br><br>"._GOBACK."<br><br>";
			CloseTable();
			echo "</td>";
			bottom();
		} else {
	...
	function StatusAdmin() {
		...
		echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
		OpenTable();
		echo "<center><font class=\"option\"><b>"._TUTADMINLEVELCONFIG."</b></font></center><br><br><br><table border=\"1\" width=\"100%\"><tr><td align=\"center\" bgcolor=\"$bgcolor2\"><b>"._TUTADMINLEVELTITLE."</b></td><td align=\"center\" bgcolor=\"$bgcolor2\" colspan=\"2\"><b>"._TUTADMINLEVELWEIGHT."</b></td><td align=\"center\" bgcolor=\"$bgcolor2\"><b>"._TUTADMINLEVELFUNCTIONS."</b></tr>";
	...
	function StatusDelete($sid, $ok=0) {
		...
		if ($ok) {
			...
			echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
			OpenTable();
			echo "<center><font class=\"option\"><b>"._TUTADMINDELLEVEL."</b></font></center>";
	...
	function tutsubmissions() {
		...
		echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
		OpenTable();
		echo "<center><font class=\"content\"><b>"._TUTADMINWAITINGSUBMISSIONS."</b></font></center><br><br>";
		...
		echo"<tr><td width=\"47%\" bgcolor=".$bgcolor3." style=\"border: 1;border-style: solid; border-size: 1px;\"><b>"._TUTMAINTUTORIAL."</b></td><td width=\"30%\" align=\"center\" bgcolor=".$bgcolor3." style=\"border: 1;border-style: solid; border-size: 1px;\"><b>"._TUTMAINSUBBY."</b></td><td width=\"18%\" bgcolor=".$bgcolor3." style=\"border: 1;border-style: solid; border-size: 1px;\"><b>"._TUTADMINSUBON."</b></td></tr>";
	...
	function subedit($subid) {
		...
		echo "<table width=\"100%\" valign=\"top\"><tr><td valign='top'>";
		OpenTable();
		echo "<center><font class=\"content\"><b>"._TUTADMINAPPROVETUTORIAL."</b></font></center><br><br>";
	...
	function block() {
		...
		$adminblock .= "<tr><td>";
		$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=tutorials\">";
		$adminblock .= ""._TUTADMINMAIN."</a> ";
		$adminblock .= "</td></tr>";
		$adminblock .= "<tr><td>";
		$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=config\">";
		$adminblock .= ""._TUTADMINCONFIG."</a> ";
		$adminblock .= "</td></tr>";
		$adminblock .= "<tr><td>";
		$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=StatusAdmin\">";
		$adminblock .= ""._TUTADMINLEVELCONFIG."</a> ";
		$adminblock .= "</td></tr>";
		$adminblock .= "<tr><td><hr>";
		$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=category\">";
		...
		if ($numrows>0) {
			$adminblock .= "<tr><td>";
			$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=modcategory\">";
			$adminblock .= ""._TUTADMINMODCAT."</a> ";
			$adminblock .= "</td></tr>";
			$adminblock .= "<tr><td><hr>";
			$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=addtutorial\">";
			$adminblock .= ""._TUTADMINADDTUT."</a> ";
			$adminblock .= "</td></tr>";
			$adminblock .= "<tr><td>";
			$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=transfercategory\">";
			$adminblock .= ""._TUTADMINTRANSFERCAT."</a> ";
			$adminblock .= "</td></tr>";
			$adminblock .= "<tr><td>";
			$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=modifytutorial\">";
			$adminblock .= ""._TUTADMINMODTUT."</a> ";
			$adminblock .= "</td></tr>";
			$adminblock .= "<tr><td><hr>";
			$result = $db->sql_query("select * from ".$prefix."_tutorials_submit");
			$num = $db->sql_numrows($result);
			$adminblock .= "<b>&#8226;</b> <a href=\"".$admin_file.".php?op=tutsubmissions\">";
			$adminblock .= ""._TUTADMINWAITINGSUBMISSIONS."</a> - <b>".$num;
			$adminblock .= "</b></td></tr>";
		}
		$adminblock .= "</table>";
	...
	function second_block() {
		...
		$adminblock .= "<table cellpadding=\"2\" cellspacing=\"0\" border=\"0\" width=\"100%\">";
		$adminblock .= "<tr><td>";
		$adminblock .= "<b>&#8226;</b> <a href=\"modules.php?name=$module_name\">";
		$adminblock .= ""._TUTMAIN."</a>";
		$adminblock .= "</td></tr>";
		$adminblock .= "<tr><td>";
		$adminblock .= "<b>&#8226;</b> <a href=\"modules.php?name=$module_name&t_op=NewTutorials\">";
		$adminblock .= ""._TUTMAINNEW."</a>";
		$adminblock .= "</td></tr>";
		$adminblock .= "<tr><td>";
		$adminblock .= "<b>&#8226;</b> <a href=\"modules.php?name=$module_name&t_op=PopularTutorials\">";
		$adminblock .= ""._TUTMAINPOPULAR."</a>";
		$adminblock .= "</td></tr>";
		$adminblock .= "<tr><td>";
		$adminblock .= "<b>&#8226;</b> <a href=\"modules.php?name=$module_name&t_op=TopTutorials\">";
