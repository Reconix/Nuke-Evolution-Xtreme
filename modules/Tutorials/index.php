...
include("modules/".$module_name."/include/menu.php");
...
function index(){
         ...
         echo "<br>";
         OpenTable();
         echo "<center><font class=\"title\"><b>"._TUTMAINTUTORIALSMAINCAT."</b></font></center><br>";
    ...
    echo "<center><font class=\"content\">"._TUTMAINTHEREARE." <b>$numrows</b> "._TUTMAINTUTORIALS." "._TUTMAINAND." <b>$catnum</b> "._TUTMAINTUTCATEGORIES." "._TUTMAININDB."</font></center>";
    CloseTable();
...
function showtutorial($pid, $tpage=0) {
	...
	$t_title = set_smilies(decode_bbcode(stripslashes($mypage[t_title]), 1, true));
	$description = set_smilies(decode_bbcode(stripslashes($mypage[description]), 1, true));
	setlocale (LC_TIME, $locale);
	preg_match ("/([0-9]{4})\-([0-9]{1,2})\-([0-9]{1,2}) ([0-9]{1,2})\:([0-9]{1,2})\:([0-9]{1,2})/i", $mypage[t_date], $datetime);
	...
	echo "<b>"._TUTMAINDESCRIPTION.":</b> ". $description ."<br>";
	echo "<b>"._TUTMAINVERSION.":</b> $mypage[version]<br>";
	echo "<b>"._TUTMAINADDEDON.":</b> $datetime<br>";
	echo "<b>"._TUTMAINAUTHOR.":</b> <a href=\"$mypage[author_homepage]\">$mypage[author]</a><br>";
...
$level = $levelrow['title'];
	echo "<b>"._TUTMAINLEVEL.":</b> $level<br>";
	echo "<b>"._TUTMAINVIEWS.":</b> $mypage[t_counter]<br>";
	    ...
	    echo " <b>"._TUTMAINRATING.":</b> $tutorialsratingsummary ($mypage[totalvotes] $votestring)<br>";
	}
	...
	echo "</td></tr></table>";
     ...
     echo "<br>";
     OpenTable();
	echo "<font class=\"title\">". set_smilies(decode_bbcode(stripslashes($mypage['t_title']), 1, true)) ."</font><br><br>";
	...
	echo "<p align=\"justify\">". set_smilies(decode_bbcode(stripslashes($contentpages[$arrayelement]), 1, true)) ."</p>";
    ...
    if ($pageno > 1) {
	    ...
	    $previous_pagenumber = $tpage - 1;
    	    echo "&nbsp;&nbsp;<b>[ <a href=\"modules.php?name=$module_name&t_op=showtutorial&pid=".$pid."&tpage=$previous_pagenumber\">";
    	    echo " &lt;&lt; "._TUTMAINPREVIOUS."</a> ]</b>&nbsp;&nbsp;";
  	}
    	$counter = 1;
	    ...
	    $next_pagenumber = $tpage + 1;
    		echo "&nbsp;<b>[ <a href=\"modules.php?name=$module_name&t_op=showtutorial&pid=".$pid."&tpage=$next_pagenumber\">";
    		echo " "._TUTMAINNEXT." &gt;&gt;</a> ]</b> ";
     	}
    }
    CloseTable();
    include("footer.php");
...
function viewtutorial($tc_id, $min, $orderby, $show) {
    ...
    echo "<center><font class=\"option\"><b>"._TUTMAINCATEGORY.": $title</b></font></center><br>";
    echo "<table border=\"0\" cellspacing=\"10\" cellpadding=\"0\" align=\"center\"><tr>";
	...
	{
		$title2 = set_smilies(decode_bbcode(stripslashes($title2), 1, true));
	...
	if ($cdescription2) {
	    echo "<br><font class=\"content\">". set_smilies(decode_bbcode(stripslashes($cdescription2), 1, true)) ."</font><br>";
	} else {
	    echo "<br>";
	}
	...
	{
		$title3 = set_smilies(decode_bbcode(stripslashes($title3), 1, true));
		if ($space>0) 
		{
			echo ",&nbsp;";
	    }
	...
	."<br><b>"._TUTMAINRESSORTED.": $orderbyTrans</b></font></center><br><br>";
	...
	$t_title = set_smilies(decode_bbcode(stripslashes($t_title), 1, true));
	...
	popgraphic($hits);
	echo "<br>";
	echo "<b>"._TUTMAINDESCRIPTION.":</b> ". set_smilies(decode_bbcode(stripslashes($description), 1, true)) ."<br>";
	echo "<b>"._TUTMAINVERSION.":</b> $version<br>";
	echo "<b>"._TUTMAINADDEDON.":</b> $datetime<br>";
	echo "<b>"._TUTMAINAUTHOR.":</b> <a href=\"$author_homepage\">$author</a><br>";
$result3=$db->sql_query("select title from ".$prefix."_tutorials_levels Where sid='$level'");
$levelrow = $db->sql_fetchrow($result3);
$level = $levelrow['title'];
	echo "<b>"._TUTMAINLEVEL.":</b> $level<br>";
	echo "<b>"._TUTMAINVIEWS.":</b> $hits<br>";
        if ($totalvotes == 1) {
	    $votestring = _TUTMAINVOTE;
        } else {
	    $votestring = _TUTMAINVOTES;
        ...
        if ($tutorialsratingsummary!="0" || $tutorialsratingsummary!="0.0") {
	    echo " <b>"._TUTMAINRATING.":</b> $tutorialsratingsummary ($totalvotes $votestring)<br>";
	}
    ...
    if ($tutorialpages!=1 && $tutorialpages!=0) {
        echo "<br><br>";
     	...
     	if ($prev>=0) {
    	    echo "&nbsp;&nbsp;<b>[ <a href=\"modules.php?name=$module_name&t_op=viewtutorial&amp;tc_id=".$caid."&amp;min=$prev&amp;orderby=$orderby&amp;show=$show\">";
    	    echo " &lt;&lt; "._TUTMAINPREVIOUS."</a> ]</b>&nbsp;&nbsp;";
  	}
    	$counter = 1;
 	$currentpage = ($max / $tutconfig['tutsperpage']);
		...
		echo "<a href=\"modules.php?name=$module_name&t_op=viewtutorial&amp;tc_id=".$caid."&amp;min=$mintemp&amp;orderby=$orderby&amp;show=$show\">$counter</a> ";
     	...
     	if ($next<$tutorialpages) {
    		echo "&nbsp;<b>[ <a href=\"modules.php?name=$module_name&t_op=viewtutorial&amp;tc_id=".$caid."&amp;min=$max&amp;orderby=$orderby&amp;show=$show\">";
    		echo " "._TUTMAINNEXT." &gt;&gt;</a> ]</b> ";
     	}
    }
    echo "</td></tr></table>";
...
function ratetutorial($lid, $user) {
	...
	."<font class=\"content\"><input type=\"submit\" value=\""._TUTMAINRATERESOURCE."\"></font>"
        ."<br><br>";
    if(is_user($user)) {
	echo "<b>"._TUTMAINSCOMMENTS.":</b><br><textarea wrap=\"virtual\" cols=\"50\" rows=\"10\" name=\"ratingcomments\"></textarea>"
 	    ."<br><br><br>"
     	    ."</font></td>";
    } else {
...
function completevote($error) {
    ...
    if ($error == "none") echo "<center><font class=\"content\"><b>"._TUTMAINCOMPLETEVOTE1."</b></font></center>";
    if ($error == "anonflood") echo "<center><font class=\"option\"><b>"._TUTMAINCOMPLETEVOTE2."</b></font></center><br>";
    if ($error == "regflood") echo "<center><font class=\"option\"><b>"._TUTMAINCOMPLETEVOTE3."</b></font></center><br>";
    if ($error == "postervote") echo "<center><font class=\"option\"><b>"._TUTMAINCOMPLETEVOTE4."</b></font></center><br>";
    if ($error == "nullerror") echo "<center><font class=\"option\"><b>"._TUTMAINCOMPLETEVOTE5."</b></font></center><br>";
}
...
function viewtutorialcomments($lid) {
    ...
    OpenTable();
    echo "<center><font class=\"option\"><b>"._TUTMAINTUTORIALPROFILE.": $displaytitle</b></font><br><br>";
    tutorialinfomenu($lid); 
	...
	$result2=$db->sql_query("SELECT rating FROM ".$prefix."_tutorials_votedata WHERE ratinguser = '$ratinguser'");
    	...
    	echo "<tr><td bgcolor=\"$bgcolor2\">"
    	    ."<font class=\"content\"><b> "._TUTMAINUSER.": </b><a href=\"modules.php?name=Your_Account&amp;op=userinfo&amp;username=$ratinguser\">$ratinguser</a></font>"
	    ."</td>"
	    ."<td bgcolor=\"$bgcolor2\">"
	    ."<font class=\"content\"><b>"._TUTMAINRATING.": </b>$rating</font>"
	    ."</td>"
...
function PopularTutorials($ratenum, $ratetype) {
    ...
    if ($mostpoptutorialspercentrigger == 1) {
	echo "<center><font class=\"option\"><b>"._TUTMAINMOSTPOPULAR." $toptutorialspercent% ("._TUTMAINOFALL." $totalmostpoptutorials "._TUTORIALS.")</b></font></center>";
    } else {
	echo "<center><font class=\"option\"><b>"._TUTMAINMOSTPOPULAR." ".$tutconfig['mostpoptutorials']."</b></font></center>";
    }
...
function TopTutorials($ratenum, $ratetype) {
    ...
    if ($toptutorialspercentrigger == 1) {
	echo "<center><font class=\"option\"><b>"._TUTMAINBESTRATED." $toptutorialspercent% ("._TUTMAINOF." $totalratedtutorials "._TUTMAINRATEDTUTORIALS.")</b></font></center><br>";
    } else {
	echo "<center><font class=\"option\"><b>"._TUTMAINBESTRATED." ".$tutconfig['toptutorials']." </b></font></center><br>";
    }
    echo "</td></tr>"
...
$level = $levelrow['title'];
	...
	if ($tutorialsratingsummary!="0" || $tutorialsratingsummary!="0.0") {
	    echo " <b>"._TUTMAINRATING.":</b> <b>$tutorialsratingsummary</b> ($totalvotes $votestring)<br>";
	}
	echo "<a href=\"modules.php?name=$module_name&t_op=FullProfile&amp;t_id=$t_id\">"._TUTMAINFULLPROFILE."</a>";
        if (is_user($user)) {
        echo " | <a href=\"modules.php?name=$module_name&t_op=AddList&amp;t_id=$t_id\">"._TUTMAINADDFAV."</a>";
...
function NewTutorials($newtutorialshowdays) {
    ...
    echo "<br>";
    OpenTable();
    echo "<center><font class=\"option\"><b>"._TUTMAINNEWTUTORIALS."</b></font></center><br>";
    $counter = 0;
    $allweektutorials = 0;
    while ($counter <= 7-1){
    ...
    echo "<center><b>"._TUTMAINTOTALNEWTUTORIALS.":</b> "._TUTMAINLASTWEEK." - $allweektutorials \ "._TUTMAINLAST30DAYS." - $allmonthtutorials<br>"
    ...
    echo "<br><center><b>"._TUTMAINTOTALFORLAST." $newtutorialshowdays "._TUTMAINDAYS.":</b><br><br>";
    $counter = 0;
    $allweektutorials = 0;
...
function NewTutorialsDate($selectdate) {
    ...
    $totaltutorials = $db->sql_numrows($db->sql_query("SELECT * FROM ".$prefix."_tutorials_tutorials WHERE t_date LIKE '%$newtutorialDB%'"));
    echo "<font class=\"option\"><b>$dateView - $totaltutorials "._TUTMAINNEWTUTORIALS."</b></font>"
...
function search($query, $min, $orderby, $show) {
    ...
    if ($query != "") {
    	if ($nrows>0) {
	    echo "<font class=\"option\">"._TUTMAINSEARCHRESULTS4.": <b>$the_query</b></font><br><br>"
	        ."<table width=\"100%\" bgcolor=\"$bgcolor2\"><tr><td><font class=\"option\"><b>"._TUTMAINUSUBCATEGORIES."</b></font></td></tr></table>";
	    ...
	    echo "<br><table width=\"100%\" bgcolor=\"$bgcolor2\"><tr><td><font class=\"option\"><b>"._TUTMAINTUTORIALS."</b></font></td></tr></table>";
    	    $orderbyTrans = convertorderbytrans($orderby);
    	    echo "<center><font class=\"content\">"._TUTMAINSORTTUTORIALSBY.": "
...
$level = $levelrow['title'];
	...
	echo "<br>";
	    ...
	    echo "<br><br><center><font class=\"option\"><b>"._TUTMAINNOMATCHES."</b></font><br><br>"._GOBACK."<br></center>";
	}
    ...
    if ($tutorialpages!=1 && $tutorialpages!=0) {
        echo "<br><br>";
     	...
     	if ($prev>=0) {
    	    echo "&nbsp;&nbsp;<b>[ <a href=\"modules.php?name=$module_name&t_op=search&amp;query=$the_query&amp;min=$prev&amp;orderby=$orderby&amp;show=$show\">";
    	    echo " &lt;&lt; "._TUTMAINPREVIOUS."</a> ]</b>&nbsp;&nbsp;";
  	}	    	
    	$counter = 1;
 	$currentpage = ($max / $tutconfig['searchtutorials']);
		...
		echo "<a href=\"modules.php?name=$module_name&t_op=search&amp;query=$the_query&amp;min=$mintemp&amp;orderby=$orderby&amp;show=$show\">$counter</a> ";
     	...
     	if ($next<$tutorialpages) {
    		echo "&nbsp;&nbsp;<b>[ <a href=\"modules.php?name=$module_name&t_op=search&amp;query=$the_query&amp;min=$max&amp;orderby=$orderby&amp;show=$show\">";
    		echo " "._TUTMAINNEXT." &gt;&gt;</a> ]</b> ";
     	}
        }
    } else {
	echo "<center><font class=\"option\"><b>"._TUTMAINNOMATCHES."</b></font></center><br><br>";
    }
    CloseTable();
    include("footer.php");
}
function FullProfile($t_id) {
    ...
    echo "<br>";
    OpenTable();
    echo "<center><font class=\"option\"><b>"._TUTMAINTUTORIALPROFILE.": $t_title</b></font><br><br>";
    ...
    echo "<tr><td align=\"center\" colspan=\"2\"><b><u>"._TUTMAINTUTORIALRATINGDET."</u></b></td></tr>";
    echo "<tr><td align=\"right\"><b>"._TUTMAINTOTALVOTES."</b></td>";
    echo "<td align=\"left\">$totalvotesDB</td></tr>";
    echo "<tr><td align=\"right\"><b>"._TUTMAINOVERALLRATING."</b></td>";
    echo "<td align=\"left\">$finalrating</td></tr>";
    echo "<tr><td colspan=\"2\">&nbsp;</td></tr>";
    echo "<tr><td align=\"center\" colspan=\"2\"><b><u>"._TUTMAINADDITIONALDET."</u></b></td></tr>";
    echo "<tr><td align=\"right\" width=\"50%\"><b>"._TUTMAINDESCRIPTION.":</b></td>";
    echo "<td align=\"left\">$description</td></tr>";
    echo "<tr><td align=\"right\" width=\"50%\"><b>"._TUTMAINAUTHOR.":</b></td>";
    ...
    echo "<tr><td align=\"right\" width=\"50%\"><b>"._TUTMAINSUBBY.":</b></td>";
    echo "<td align=\"left\">$submitter2</td></tr>";
    }
    echo "<tr><td align=\"right\"><b>"._TUTMAINVERSION.":</b></td><td align=\"left\">$version</td></tr>";
    echo "<tr><td align=\"right\"><b>"._TUTMAINADDEDON.":</b>";
    echo "</td><td align=\"left\">$datetime</td></tr>";
$result3=$db->sql_query("select title from ".$prefix."_tutorials_levels Where sid='$level'");
$levelrow = $db->sql_fetchrow($result3);
$level = $levelrow['title'];
    echo "<tr><td align=\"right\"><b>"._TUTMAINLEVEL.":</b>";
    echo "</td><td align=\"left\">$level</td></tr>";
    echo "<tr><td align=\"right\"><b>"._TUTMAINVIEWS.":</b></td>";
	...
	."<font class=\"content\"><b>"._TUTMAINREGISTEREDUSERS."</b></font>"
	."</td></tr>"
	."<tr>"
	."<td bgcolor=\"$bgcolor1\">"
	...
	."<tr><td valign=\"top\" colspan=\"2\"><font class=\"tiny\"><br><br>"._TUTMAINWEIGHNOTE." ".$tutconfig['anonweight']." "._TUTMAINTO." 1.</font></td></tr>"
        ."<tr><td colspan=\"2\" bgcolor=\"$bgcolor2\"><font class=\"content\"><b>"._TUTMAINUNREGISTEREDUSERS."</b></font></td></tr>"
...
function FavoriteTutorials(){
    ...
    echo "<br>";
    OpenTable();
    echo "<center><font class=\"option\"><b>"._TUTMAINFAVORITE."</b></font></center><br>";
...
if (is_user($user)){
    ...
    echo "<center><font class=\"option\"><b>"._TUTMAINFAVORITE."</b></font><br><br>";
...
$db->sql_query("UPDATE ".$prefix."_tutorials_favorites SET showlist=0 WHERE fav_id='$fav_id'");
    ...
    OpenTable();
	echo "<center>";
	echo "<font class=\"option\"><b>"._TUTMAINFAVORITE."</b></font>";
	echo "<br><br>";
