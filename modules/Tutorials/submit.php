...
function index(){
	...
	echo "<form method=\"post\" name=\"post\" action=\"modules.php?name=".$module_name."\">"
	    ."<font class=\"content\"><b>"._TUTADMINADDNEWTUTORIAL."</b><br><br>"
...
echo "</select><br><br>";
	    ...
	    ."</form>";
    	 ...
    	 echo "<font class=\"content\"><center><b>"._TUTMAINSUBRES."</b></center>";
...
function tutorial_form(){
    global $module_name;
        include("include/bbcode_javascript.php");
...
function savetutorial($t_title, $tc_id, $description, $t_text, $author, $author_email, $author_homepage, $version, $level, $submitter) {
	...
	echo "<br><center>"
	    ."<font class=\"content\">"
	    ."<b>"._TUTADMINERRORNOTITLE."</b><br><br>"
	    .""._GOBACK."<br><br>";
	CloseTable();
	include("footer.php");
    }
	...
	echo "<br><center>"
	    ."<font class=\"content\">"
	    ."<b>"._TUTADMINERRORNODESCRIPTION."</b><br><br>"
	    .""._GOBACK."<br><br>";
	CloseTable();
	include("footer.php");
    }
	...
	echo "<br><center>"
	    ."<font class=\"content\">"
	    ."<b>"._TUTADMINERRORNOTUTORIAL."</b><br><br>"
	    .""._GOBACK."<br><br>";
	CloseTable();
	include("footer.php");
    }
	...
	echo "<br><center>"
	    ."<font class=\"content\">"
	    ."<b>"._TUTADMINERRORNOAUTHOR."</b><br><br>"
	    .""._GOBACK."<br><br>";
	CloseTable();
	include("footer.php");
    }
	...
	echo "<br><center>"
	    ."<font class=\"content\">"
	    ."<b>"._TUTADMINERRORNOAUTHORMAIL."</b><br><br>"
	    .""._GOBACK."<br><br>";
	CloseTable();
	include("footer.php");
    }
	...
	echo "<br><center>"
	    ."<font class=\"content\">"
	    ."<b>"._TUTADMINERRORNOAUTHORSITE."</b><br><br>"
	    .""._GOBACK."<br><br>";
	CloseTable();
include("footer.php");
    }
	...
	echo "<br><center>"
	    ."<font class=\"content\">"
	    ."<b>"._TUTADMINERRORNOVERSION."</b><br><br>"
	    .""._GOBACK."<br><br>";
	CloseTable();
    include("footer.php");
    }
    ...
    include ("header.php");
         ...
         echo "<br>";
    OpenTable();
    echo "<font class=\"content\"><center><b>"._TUTMAINSUBSUC."</b></center>";
    echo "<br><center>";
