...
function parse_bbcode($hometext, $bbcode_uid){
		...
		$bbcode_tpl['code_open'] = "<table width=\"85%\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\" align=\"center\"><tr><td><span class=\"genmed\"><b>"._TUTBBCODE.":</b></span></td></tr><tr><td class=\"code\">";
		$bbcode_tpl['code_close'] = "</td></tr></table>";
		$bbcode_tpl['align_open'] = "<div style=\"text-align:$1\">";
		$bbcode_tpl['align_close'] = "</div>";
		$bbcode_tpl['quote_open'] = "<table width=\"85%\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\" align=\"center\"><tr><td><span class=\"genmed\"><b>"._TUTBBQUOTE.":</b></span></td></tr><tr><td class=\"quote\">";
		$bbcode_tpl['quote_close'] = "</td></tr></table>";
		$bbcode_tpl['quote_username_open'] = "<table width=\"85%\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\" align=\"center\"><tr><td><span class=\"genmed\"><b>$1 "._TUTBBWROTE.":</b></span></td></tr><tr><td class=\"quote\">";
