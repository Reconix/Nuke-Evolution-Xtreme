...
define("_STATSNOTSEND","Statistics for the selected Banner can't be sent because<br />there isn't an email associated with it.<br />Please contact the Administrator");
