...
switch($op){
  	...
  	case 'visit':        include_once(NUKE_MODULES_DIR.$module_name.'/public/visit.php'); break;  
  	case 'submitbutton': include_once(NUKE_MODULES_DIR.$module_name.'/public/submit.php'); break;
	case 'submit_save':  include_once(NUKE_MODULES_DIR.$module_name.'/public/submitsave.php'); break;
	
	default: include_once(NUKE_MODULES_DIR.$module_name.'/public/index.php'); break;
