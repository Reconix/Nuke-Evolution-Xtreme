...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  <tr> 
    <td class="row1pic" colspan="2" height="28"><span class="cattitle2"><a href="{U_VIEWONLINE}" class="cattitle2">{L_WHO_IS_ONLINE}</a></span></td>
  </tr>
  <tr> 
    <td class="row1" align="center" valign="middle" rowspan="3"><img src="themes/ChromoWB/forums/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" /></td>
  ...
  <!-- BEGIN birthdays -->
  <tr>
	<td class="row1pic" colspan="2" height="28"><span class="cattitle2">{L_TODAYS_BIRTHDAYS}</span></td>
  </tr>
  <tr> 
...
<input type="hidden" name="op" value="login">
  <table align="center" width="54%" cellpadding="3" cellspacing="1" border="0" class="forumline">
    <tr> 
      <td class="row1pic" height="28"><a name="login"></a><span class="cattitle2">{L_LOGIN_LOGOUT}</span></td>
    </tr>
    <tr> 
...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
    <td width="20" align="center"><img src="themes/ChromoWB/forums/images/folder_new.gif" alt="{L_NEW_POSTS}"/></td>
    <td><span class="gensmall">{L_NEW_POSTS}</span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/ChromoWB/forums/images/folder.gif" alt="{L_NO_NEW_POSTS}" /></td>
    <td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/ChromoWB/forums/images/folder_lock.gif" alt="{L_FORUM_LOCKED}" /></td>
