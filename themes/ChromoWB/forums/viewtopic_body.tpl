...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
    ...
    <tr> 
        ...
        <br /><br />{postrow.EDIT_IMG} {postrow.DELETE_IMG} {postrow.IP_IMG} {postrow.REPORT_IMG}</div><br /><br />{postrow.POSTER_GENDER}<br />{postrow.POSTER_JOINED}<br />{postrow.POSTER_AGE}{postrow.POSTER_POSTS}<br />{postrow.POSTER_FROM}<br />{postrow.REPUTATION}<br />{postrow.POSTER_FROM_FLAG}<br /><br /><div align="center">{postrow.PROFILE_IMG} {postrow.PM_IMG} {postrow.EMAIL_IMG}</div><br />{postrow.POSTER_ONLINE_STATUS}<!-- -->
        <!-- BEGIN xdata -->
    ...
    <tr> 
        ...
        <td class="{postrow.ROW_CLASS}" width="100%" height="28" valign="bottom" nowrap="nowrap"><table cellspacing="0" cellpadding="0" border="0" width="18">
            <tr> 
                <td valign="middle" nowrap="nowrap">{postrow.WWW_IMG} {postrow.AIM_IMG} {postrow.YIM_IMG} {postrow.MSN_IMG} {postrow.FACEBOOK_IMG} {postrow.MYSPACE_IMG}<script language="JavaScript" type="text/javascript"><!-- 
...
<tr>
  ...
  <td align="center" class="inlinead" width="100%" height="28" valign="top">
    {postrow.INLINE_AD}
  </td>
</tr>
<tr>
...
<tr>
  <td colspan=2 class="inlinead" align="center">
    {postrow.INLINE_AD}
  </td>
</tr>
...
<!-- END postrow -->
    <tr align="center"> 
        <td class="catBottom" colspan="2" height="28"><table cellspacing="0" cellpadding="0" border="0">
            <tr><td align="center" style="padding-top:6px;"><form method="post" action="{S_POST_DAYS_ACTION}"><span class="gensmall">{L_DISPLAY_POSTS}: {S_SELECT_POST_DAYS}{S_SELECT_POST_ORDER}<input type="submit" value="{L_GO}" class="liteoption" name="submit" /></span></form></td></tr>
        </table></td>
    </tr>
</table>
