...
&nbsp;&middot;&nbsp;&nbsp;<a href="{U_PRIVATEMSGS}" class="mainmenu">{PRIVATE_MESSAGE_INFO}</a>
<br />
<a href="{U_ARCADE}" class="mainmenu">{L_ARCADE}</a>
&nbsp;&middot;&nbsp;&nbsp;<a href="{U_RANKS}" class="mainmenu">{L_RANKS}</a>
