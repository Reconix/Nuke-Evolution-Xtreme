...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <!-- BEGIN forumrow -->
  <!-- IF ! forumrow.PARENT -->
  <tr id="forum_{catrow.CAT_ID}_{catrow.forumrow.FORUM_ID}"> 
	...
	<td class="row1" width="100%" height="50" onmouseover="this.style.backgroundColor='#cccccc'" onmouseout="this.style.backgroundColor='#e0e0e0'" onclick="window.location.href='{catrow.forumrow.U_VIEWFORUM}'"><span {catrow.forumrow.FORUM_COLOR} class="forumlink"> <a href="{catrow.forumrow.U_VIEWFORUM}" {catrow.forumrow.FORUM_COLOR} class="forumlink">{catrow.forumrow.FORUM_NAME}</a><br />
...
<!-- BEGIN switch_forum_link_off -->
	<td class="row3" align="center" valign="middle" height="50"><span class="gensmall">{catrow.forumrow.TOTAL_TOPICS}</span></td>
