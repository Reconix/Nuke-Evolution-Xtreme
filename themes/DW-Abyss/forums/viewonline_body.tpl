...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
    <td class="catSides" colspan="3" height="28"><span class="cattitle"><strong>{TOTAL_REGISTERED_USERS_ONLINE}</strong></span></td>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <!-- END reg_user_row -->
  <tr> 
    <td colspan="3" height="1" class="row3"><img src="themes/DW-Abyss/forums/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
  <tr> 
    <td class="catSides" colspan="3" height="28"><span class="cattitle"><strong>{TOTAL_GUEST_USERS_ONLINE}</strong></span></td>
  </tr>
