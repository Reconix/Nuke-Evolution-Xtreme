...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
    ...
    <tr>
        <td class="row1">
            ...
            <span class="gen"><strong>{faq_block_link.BLOCK_TITLE}</strong></span><br />
            <!-- BEGIN faq_row_link -->
...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
    ...
    <!-- BEGIN faq_row -->  
    <tr> 
        <td class="{faq_block.faq_row.ROW_CLASS}" align="left" valign="top"><span class="postbody"><a name="{faq_block.faq_row.U_FAQ_ID}"></a><strong>{faq_block.faq_row.FAQ_QUESTION}</strong></span><br /><span class="postbody">{faq_block.faq_row.FAQ_ANSWER}<br /><a class="postlink" href="#top">{L_BACK_TO_TOP}</a></span></td>
    </tr>
    <tr>
        <td class="spaceRow" height="1"><img src="themes/DW-Abyss/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
    </tr>
    <!-- END faq_row -->
</table>
